...
class KinematicsDashboard:
    ...
    def _build_ui(self):
        ...
        self.f_max_input = widgets.BoundedIntText(
            ...
            description="f_max (Hz):", layout=widgets.Layout(width="170px")
        )
            ...
            while self._is_running:
                ...
                if dma.recvchannel.idle:
                    ...
                    if amp_a0 >= squelch and len(x_ac_a0) >= 128:
                        ...
                        f0_a0, _ = KinematicAnalytics.track_sub_hertz_pitch(self.freq_axis, mag_db0, min_freq_hz=f_min, max_freq_hz=f_max, interpolate=True)
                    else:
                        f0_a0 = np.nan

                    # Pitch tracking Channel 2 (A1)
                    if amp_a1 >= squelch and len(x_ac_a1) >= 128:
                        ...
                        f0_a1, _ = KinematicAnalytics.track_sub_hertz_pitch(self.freq_axis, mag_db1, min_freq_hz=f_min, max_freq_hz=f_max, interpolate=True)
                    else:
                        f0_a1 = np.nan
